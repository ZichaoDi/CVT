...
%%%------------------------------------------------------------------------
% %%%mg
tt=2;fmg; [f,g]=sfun(v);[f0,g0]=sfun(v0);fvmg(1)=f0;
...
semilogy(iter_opt(1:end),error_opt(1:end),'b*-');text(iter_opt(end),error_opt(end),' \leftarrow OPT_fmincon','FontSize',18);
