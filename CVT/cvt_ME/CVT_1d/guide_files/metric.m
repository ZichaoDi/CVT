function varargout = metric(varargin)
% METRIC M-file for metric.fig
%      METRIC, by itself, creates a new METRIC or raises the existing
%      singleton*.
%
%      H = METRIC returns the handle to a new METRIC or the handle to
%      the existing singleton*.
%
%      METRIC('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in METRIC.M with the given input arguments.
%
%      METRIC('Property','Value',...) creates a new METRIC or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before metric_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to metric_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help metric
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @metric_OpeningFcn, ...
                   'gui_OutputFcn',  @metric_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before metric is made visible.
function metric_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to metric (see VARARGIN)

% Choose default command line output for metric
...
% UIWAIT makes metric wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = metric_OutputFcn(hObject, eventdata, handles)
