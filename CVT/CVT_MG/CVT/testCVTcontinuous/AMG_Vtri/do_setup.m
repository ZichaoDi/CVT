...
global xlimit ylimit k tribond c2 
%----------------------------------------------------------------------
...
c2=1:N(1)-1;%[];% index of generators fixed at the exact solution and the corresponding
                %%% search direction set to zero in TN
v0=XY{1};
pert1 = 1e-1;
pert2 = 0;
for i=1:N(1)
    v1=v0(1,i)+pert1*i;
    v2=v0(2,i)+pert2*i;
    if(v2<sqrt(3)*v1+50*sqrt(3) & v2<-sqrt(3)*v1+50*sqrt(3) & v2>0 & ismember(i,c2)==0)
