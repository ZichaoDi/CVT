...
alpha=[1/3 1/3 1/3;1/5 1/5 3/5;3/5 1/5 1/5;1/5 3/5 1/5];
% alpha is the degree of f with cubic and the corresponding area coordinates of the integration point k, and w
% is the weight.
w=[-27/48;25/48;25/48;25/48];
xNode=alpha*x; yNode=alpha*y;
A=(x(2)*y(3)-x(3)*y(2)-x(1)*y(3)+x(3)*y(1)+x(1)*y(2)-x(2)*y(1))/2;
sum=0;
for i=1:4
